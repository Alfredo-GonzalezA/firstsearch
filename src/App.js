...
// Create each square with the id which we need to change the background color for the algorithm an onsquare function to make the appropriate actions to each square
...
export default function Board() {
    ...
    function getValidNeighbors(index, grid) {
        ...
        for (const [dx, dy] of directions) {
            ...
            if (newRow >= 0 && newRow < rowSize && newCol >= 0 && newCol < rowSize && grid[newIndex] !== 'B') {
